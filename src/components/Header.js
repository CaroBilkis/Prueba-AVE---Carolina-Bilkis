...
<div className='relative w-full  '>
        <div className='flex flex-col w-full h-[560px] justify-center items-center relative overflow-hidden'>
              ...
              <img className='w-full h-full object-cover scale-105   absolute top-0 z-0 blur-sm' src="percha.jpg" alt="Hero image" />
      </div>
